...
function loadItems() {
  ...
  if (!storedItems) {
    return [
      { title: "Noruoz", checked: false },
      { title: "BargoJet", checked: false },
      { title: "Get Travel", checked: false },
      { title: "Sea", checked: false },
      { title: "Rest time in sea", checked: false },
      { title: "Come Back", checked: false },
    ];
  }
